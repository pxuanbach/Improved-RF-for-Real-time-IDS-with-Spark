...
from pyspark.ml.classification import XGBoostClassifier, RandomForestClassifier
...
xgboost_params = {
    "featuresCol": "features",
    "labelCol": "label",
    "num_round": 200,           # Number of trees (equivalent to n_estimators=200)
    "max_depth": 10,            # Maximum depth of each tree
    "eta": 0.05,                # Learning rate
    "subsample": 0.8,           # Subsampling ratio of training instances
    "colsample_bytree": 0.8,    # Subsampling ratio of columns for each tree
    "objective": "multi:softprob",  # Multi-class classification
    "eval_metric": "mlogloss",  # Evaluation metric: multiclass logloss
    "num_class": len(label_to_name),  # Number of classes
    "seed": 42,                 # Ensure reproducibility
    "num_workers": 3            # Number of workers (adjust based on cluster)
}
