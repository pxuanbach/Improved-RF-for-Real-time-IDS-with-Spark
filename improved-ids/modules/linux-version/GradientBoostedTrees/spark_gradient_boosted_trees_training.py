...
parser = argparse.ArgumentParser(description="Gradient Boosted Trees with OneVsRest Training with Spark")
parser.add_argument(
    "--output-dir",
    type=str,
    default=None,
...
# Train Gradient Boosted Trees with OneVsRest
start_time = time.time()
gbt = GBTClassifier(
    featuresCol="features",
    labelCol="label",
    maxIter=50,           # Number of trees (equivalent to n_estimators=200)
    maxDepth=5,           # Maximum depth of each tree
    stepSize=0.1,         # Learning rate
    subsamplingRate=0.5,   # Subsampling rate for each tree
